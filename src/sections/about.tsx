...
const About: React.FC = () => (
  <section className="flex flex-col justify-items-start items-start space-y-4 text-left text-sm font-semibold py-8 opacity-70">
    <p>
    ...
    <p>
      ...
      <span className="font-extrabold text-white">Firebase</span>,{" "}
      <span className="font-extrabold text-white">Flutter</span>,{" "}
      <span className="font-extrabold text-white">Prisma</span>,{" "}
      <span className="font-extrabold text-white">Drizzle ORM</span>, and
